# VRAP (Vintage Resourcify API Plugin)

Allows to set Vintage Resourcify CurseForge API token from remote URL.
Uses PolyMC proxy by default.
...
![license](images/WTFPL_badge.png)
